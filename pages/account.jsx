  ...
  if (session) {
    ...
    return (
      <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
        ...
        <button className='flex items-center justify-center p-3 bg-gray-600 borger-gray-600 my-2'         onClick={() => signIn()}>< FaGithub className='mr-2 '/> Sign in with <span className='font-bold pl-1'>Github</span></button>
        <button
